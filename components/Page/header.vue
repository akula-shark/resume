...
<template>
  <div>
    <section class="card card--padding flex flex-col space-y-8">
      <h1 class="text--primary text-4xl font-bold">{{ title }}</h1>
      <p class="text--secondary">
        {{ description }}
      </p>
      <a
        href="https://www.icloud.com/iclouddrive/07dhqaFQ9HJAirYt_PkjtTyyg#Untitled%5FArtwork"
        v-if="showDownloadButton"
        class="button button--green hover:button--hover"
        to="/resume"
      >
        <svg
